package com.gokhangulen.cryptotracker;
...
public class CurrencyRVAdapter extends RecyclerView.Adapter<CurrencyRVAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            currencyNameTV = itemView.findViewById(R.id.nameText);
            symbolTV = itemView.findViewById(R.id.symbolText);
            rateTV = itemView.findViewById(R.id.rateText);
        }
    }
}
